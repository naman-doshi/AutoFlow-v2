...
// Update AutoFlow to remove partitioning, custom heuristic, and reservation table
void AutoFlow() {
    ...
    cout << "Starting pathfinding with " << CPU_THREADS << " threads and work stealing..." << endl;
    ...
    // Create processing threads with work stealing
